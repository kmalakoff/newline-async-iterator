...
const newlineIterator = require("newline-async-iterator/dist/umd/newline-async-iterator.min.js");
const stringIterator = require("../lib/stringIterator.cjs");

describe("exports newline-async-iterator/dist/umd/newline-async-iterator.min.js", function () {
